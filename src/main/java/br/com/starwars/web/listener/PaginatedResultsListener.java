package br.com.starwars.web.listener;
...
@Component
public class PaginatedResultsListener implements ApplicationListener<PaginatedResultsRetrievedEvent> {

	private static final String PAGE = "page";

	public PaginatedResultsListener() {
		super();
	}
	...
	// ATENCAO: a URI eh colocada no plural de maneira 'hardcoded'
	...
	protected void pluralizeUri(final UriComponentsBuilder uriBuilder, final Class clazz) {
